...
for name in [
    ...
    "out-v2-pack-spans-marks-hotset",
    "out-v2-pack-spans-fill-copy",
    "out-v2-pack-spans-arc-close-95431fc",
    "out-v2-pack",
    "out-v1-json",
]:
    p = phase / name
...
for pat in [
    ...
    "phase_timings_B_marks_hotset.json",
    "phase_timings_B_fill_copy.json",
    "phase_timings_B_arc_close_95431fc.json",
    "RECEIPT_REPLAY_FILL_COPY.md",
    "SPEC_REPLAY_FILL_COPY_20260924.md",
    "KIMI_REVIEW_189.md",
    "KIMI_REVIEW_192.md",
    "CODEX_REVIEW_189.md",
    "CODEX_REVIEW_192.md",
    "RECEIPT_REPLAY_MARKS_HOTSET.md",
    "SPEC_REPLAY_FILL_COPY_20260924.md",
    ...
    "_tmp_forbidden_mtime_snapshot_marks_hotset.json",
    "_tmp_forbidden_mtime_snapshot_fill_copy.json",
    "_tmp_forbidden_mtime_snapshot_fill_copy_rerun.json",
]:
    p = phase / pat
    if p.exists():
        forbidden.append(p)
...
out = phase / "_tmp_forbidden_mtime_snapshot_arc_close2.json"
