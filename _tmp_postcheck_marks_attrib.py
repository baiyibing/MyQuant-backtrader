"""Post-run checks for marks attribution run at be3ce4f: SHA parity, forbidden mtimes, business clean."""
import hashlib
import json
...
new = phase / "out-v2-pack-spans-be3ce4f-marks-cprofile" / "joint-return-control-only-50-5-narrow-clock-patch-614"
...
snap = json.loads((phase / "_tmp_forbidden_mtime_snapshot_marks_attrib.json").read_text(encoding="utf-8"))
changed, missing = [], []
...
print("PARITY_OK:", ok_parity, "| FORBIDDEN_OK:", not changed and not missing, "| PIN_RESTORED:", stock in text and pin not in text)
