...
new = phase / "out-v2-pack-spans-fill-copy" / "joint-return-control-only-50-5-narrow-clock-patch-614"
...
snap = json.loads((phase / "_tmp_forbidden_mtime_snapshot_fill_copy.json").read_text(encoding="utf-8"))
changed, missing = [], []
