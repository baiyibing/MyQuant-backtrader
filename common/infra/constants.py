...
class EnvVarKeys:
    ...
    OSKH_PREHEAT_SOURCE: Final[str] = "OSKH_PREHEAT_SOURCE"
    OSKH_L2_PARQUET_ROOT: Final[str] = "OSKH_L2_PARQUET_ROOT"
    OSKH_SOURCE_PARQUET_ROOT: Final[str] = "OSKH_SOURCE_PARQUET_ROOT"
    OSKH_XTDATA_BUDGET_ENABLED: Final[str] = "OSKH_XTDATA_BUDGET_ENABLED"
    OSKH_XTDATA_BUDGET_SEC: Final[str] = "OSKH_XTDATA_BUDGET_SEC"
    OSKH_FASTPATH_READ_BATCH_SIZE: Final[str] = "OSKH_FASTPATH_READ_BATCH_SIZE"
    OSKH_FASTPATH_READ_BATCH_TIMEOUT_SEC: Final[str] = "OSKH_FASTPATH_READ_BATCH_TIMEOUT_SEC"
    OSKH_FASTPATH_READ_TOTAL_TIMEOUT_SEC: Final[str] = "OSKH_FASTPATH_READ_TOTAL_TIMEOUT_SEC"
    OSKH_FASTPATH_READ_FAIL_RATE_THRESHOLD: Final[str] = "OSKH_FASTPATH_READ_FAIL_RATE_THRESHOLD"
    OSKH_DOWNLOAD_START_TIMEOUT_SEC: Final[str] = "OSKH_DOWNLOAD_START_TIMEOUT_SEC"
    OSKH_DOWNLOAD_STALL_TIMEOUT_SEC: Final[str] = "OSKH_DOWNLOAD_STALL_TIMEOUT_SEC"
    OSKH_DOWNLOAD_TOTAL_TIMEOUT_SEC: Final[str] = "OSKH_DOWNLOAD_TOTAL_TIMEOUT_SEC"
    OSKH_ACK_QMT_DOWNLOAD_RESTART: Final[str] = "OSKH_ACK_QMT_DOWNLOAD_RESTART"
