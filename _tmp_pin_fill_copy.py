...
bak = Path(r"D:\PycharmProjects\MyQuant-backtrader\backtest\research\joint_return_replay.py.bak_fill_copy_pin_20260924")
...
knives = ("backfill_scan_steps", "cannot rewrite history")  # marks-hotset + fill-copy markers
