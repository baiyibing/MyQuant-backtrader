...
> **状态**：✅ **v1.1 · A/B/C 已实施；切片 D 宿主已完成 2026-09-16**（[短记](v8-rules-v2-slice-d-host-note-2026-09-16.md)；日线 `skip_cash=522` 待业务裁 §8）。评审记录：[zcode-facts](../architecture/reviews/2026-09-16/plan-v8-rules-v2/zcode-facts.md) / [zcode-arch](../architecture/reviews/2026-09-16/plan-v8-rules-v2/zcode-arch.md) / [merge-consensus](../architecture/reviews/2026-09-16/plan-v8-rules-v2/merge-consensus.md)。
...
- **v1.1+D**（2026-09-16）：宿主切片 D 完成。[短记](v8-rules-v2-slice-d-host-note-2026-09-16.md)：`days==1` trail 59.3%→0%；日线峰值 536 只 / 5.65 亿，`skip_cash=522`（§8 四选项待裁）。
...
| D · 宿主 5 亿重跑 | ✅ | host 2026-09-16 | [短记](v8-rules-v2-slice-d-host-note-2026-09-16.md)。`days==1` trail 59.3%→**0%**；日线峰值 536 只 / 5.65 亿，`skip_cash=522` |
