...
| [`../plan-h15-d2-minute-chip-numba-2026-09-15.md`](../plan-h15-d2-minute-chip-numba-2026-09-15.md) | **H15/D2：optional numba** `minute_chip_distribution`（Python 默认；parity + bench） |
