...
| **PR #60（GPU plan）** | ✅ 已合入并归档（merge `bc98a38`；回测 STOP / 关 S2 / 不开 S3） | 权威副本 [_archive/plans/…](_archive/plans/plan-gpu-accel-4090-2026-09-16.md)；root 指针保留；GPU 项目关闭 |
