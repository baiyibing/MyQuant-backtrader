...
> **人裁 GO（2026-09-16）**：PX-1…PX-7 全部裁 **是**（与上表建议一致）。检测门=ex_date_index 主 ∪ 跳变>1e-2 兜底；噪声 ≤0.5% 不修正；买入日新 lot 不调整；v4 SMA 残留另开；E-R6 三句残留 + D 回收上界；v7 不接。本分支 `feat/exdiv-refprice` 实施中。
