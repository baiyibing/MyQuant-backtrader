...
| 目录 | 说明 |
|------|------|
| [chip/](chip/) | Chip 因子与 cost-migration；**H11 inventory** → [chip/chip-slowpath-inventory-2026-09-15.md](chip/chip-slowpath-inventory-2026-09-15.md)（含 **H13** 边界 + **H14/D1** profile 结果） |
