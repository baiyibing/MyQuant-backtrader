...
用法：
  python scripts/research/full_market_equal_weight_resist_v2.py --date 20260515
  python scripts/research/full_market_equal_weight_resist_v2.py --date 20260515 --window 120
"""
