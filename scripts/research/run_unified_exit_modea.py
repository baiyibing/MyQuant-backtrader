#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""CLI entry for unified-exit Mode A grid (assembly / evaluate / report).

Usage (host with F lake; Slice D — not a merge gate)::
...
from backtest.research.unified_exit_modea import main  # noqa: E402
