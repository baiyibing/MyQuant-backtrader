...
用法：
    python scripts/data/full_market_chip_resist.py
    python scripts/data/full_market_chip_resist.py --date 20260515 --output full_market.csv
"""
...
def main() -> int:
    ...
    for s in all_stocks:
        ...
        try:
            ...
            arr = adapt_columns(cast(Any, df_w), stock_code=s, as_of_date=as_of_t)
