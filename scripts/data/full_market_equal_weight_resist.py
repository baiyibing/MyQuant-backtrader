...
def _process_one(args):
    ...
    try:
        ...
        cyqk_t = _calc_equal_weight_cyqk(cast(Any, df_t), code, window=window)
        cyqk_prev = _calc_equal_weight_cyqk(cast(Any, df_prev), code, window=window)
        ...
        try:
            arr_t = adapt_columns(cast(Any, df_t.tail(window)), stock_code=code, as_of_date=target)
