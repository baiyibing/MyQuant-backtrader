...
用法：
    python scripts/data/chip_window_sensitivity.py
    python scripts/data/chip_window_sensitivity.py --dates 3
"""
...
from oskh_factors.chip.core import compute_chip_factors
