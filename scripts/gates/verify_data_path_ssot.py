...
# Master residual debt until path-SSOT feature lands; counts must not grow.
_ALLOWLIST: Dict[str, Tuple[str, int]] = {
    ...
    "scripts/full_market_chip_resist.py": ("MASTER_PENDING", 1),
    "scripts/rebuild_front_duckdb_standalone.py": ("LEGIT_TR", 1),
    "scripts/spot_check_chip_factors.py": ("MASTER_PENDING", 1),
    "scripts/update_adjusted_daily.py": ("MASTER_PENDING", 2),
}
