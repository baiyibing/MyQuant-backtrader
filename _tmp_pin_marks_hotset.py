...
bak = Path(r"D:\PycharmProjects\MyQuant-backtrader\backtest\research\joint_return_replay.py.bak_marks_hotset_pin_20260924")
...
knife = "backfill_scan_steps"  # hot-set knife marker must survive pin/restore
text = biz.read_text(encoding="utf-8")
if knife not in text:
    raise SystemExit("knife marker missing from business file - refusing to pin")
...
print("after:", "PINNED" if pin in t else "NOT_PINNED", "; stock_present=", stock in t, "; knife=", knife in t)
