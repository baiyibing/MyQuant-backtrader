...
new = phase / "out-v2-pack-spans-arc-close-95431fc" / "joint-return-control-only-50-5-narrow-clock-patch-614"
...
snap = json.loads((phase / "_tmp_forbidden_mtime_snapshot_arc_close.json").read_text(encoding="utf-8"))
changed, missing = [], []
