...
用法：
    python backtest/research/verify_minute_chip.py
"""
...
def main():
    ...
    arr_min = adapt_columns(df_min, stock_code=STOCK_CODE)
    ...
    arr_day = adapt_columns(df_day, stock_code=STOCK_CODE)
    ...
    day_close_diff = (daily_ranges["close"].values[-10:] - df_day["close"].values[-10:]).std()
