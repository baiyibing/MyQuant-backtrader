...
用法：
    ...
    python backtest/research/chip_selection_backtest.py --all

    # 分钟线模式
    python backtest/research/chip_selection_backtest.py --all --freq 1m

    # 抽样 200 只
    python backtest/research/chip_selection_backtest.py --sample 200 --freq 1m

    # 全量 2,079 只
    python backtest/research/chip_selection_backtest.py --all

    # 指定 chip CSV
    python backtest/research/chip_selection_backtest.py --chip-csv backtest_output/chip_daily_20260513.csv
