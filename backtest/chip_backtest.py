...
用法：
    python backtest/chip_backtest.py                          # 默认日期最近的 stock_pool，日线
    python backtest/chip_backtest.py --date 20260513          # 指定日期，日线
    python backtest/chip_backtest.py --freq 1m                # 分钟线
    python backtest/chip_backtest.py --freq 1m --stocks 000001.SZ,000002.SZ
    python backtest/chip_backtest.py --date 20260513 --top 20 # 限前 20 只
