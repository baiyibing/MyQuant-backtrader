...
if __name__ == '__main__':
    ...
    strategies = [
        ...
        ('version6', None, "策略6: 6%止损 + 1%锚定分档(T+1=30%/T+2=40%/T+3=50%/T+4=60%/T+5+=70%) + 尾盘涨停次日09:45追买"),
        ('version8', None, "策略8: 20%止损 + 摸到+6%后回撤到+2% + 15%锚绝对涨幅分档回撤 + 涨幅>120%最高价回撤20% + 已持加仓各笔独立 + 尾盘涨停次日09:45追买"),
